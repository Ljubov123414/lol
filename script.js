...
var items = [
	...
	{name:'Knife Case', price:0.00, class:'standard', case:'knife', type:'case', needkey:false, rankNeeded:0},
	...
	// Keys
	{name:'Spectrum Case Key', price:0, class:'standard', case:'spectrum', type:'key'},
	{name:'CS:GO Weapon Case Key', price:0, class:'standard', case:'csgo_weapon csgo_weapon2 csgo_weapon3', type:'key'},
	{name:'Shadow Case Key', price:0, class:'standard', case:'shadow', type:'key'},
	{name:'Falchion Case Key', price:0, class:'standard', case:'falchion', type:'key'},
	{name:'Operation Vanguard Case Key', price:0, class:'standard', case:'vanguard', type:'key'},
	{name:'Chroma Case Key', price:0, class:'standard', case:'chroma', type:'key'},
	{name:'Gamma Case Key', price:0, class:'standard', case:'gamma', type:'key'},
	{name:'Chroma Case 2 Key', price:0, class:'standard', case:'chroma2', type:'key'},
	{name:'Gamma Case 2 Key', price:0, class:'standard', case:'gamma2', type:'key'},
	{name:'Chroma Case 3 Key', price:0, class:'standard', case:'chroma3', type:'key'},
	{name:'Operation Hydra Case Key', price:0, class:'standard', case:'hydra', type:'key'},
	{name:'Revolver Case Key', price:0, class:'standard', case:'revolver', type:'key'},
	...
	// Karambit
	{name:'Karambit', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Autotronic', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Gamma Doppler', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	...
	{name:'Karambit | Black Laminate', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Freehand', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Bright Water', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Marble Fade', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Tiger Tooth', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Doppler', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Damascus Steel', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Ultraviolet', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Rust Coat', price:999999.420, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
	{name:'Karambit | Fade', price:999999, class:'exceedingly_rare', case:'knife csgo_weapon csgo_weapon2 csgo_weapon3 vanguard', type:'skin', stattrak:true},
...
var upgrades = [
	{name:'Bank',price:0,dec:'Earn 50â‚¬ more when offline',priceboost:0},
	{name:'Offline Production',price:0,dec:'Earn offline money faster',priceboost:0},
	{name:'+CASH',price:0,dec:'Get more cash per click',priceboost:0},
	{name:'Luck',price:0,dec:'Higher chance of opening good skins',priceboost:0},
	{name:'Online Production',price:0,dec:'+0.10â‚¬ every secound',priceboost:0}
]
var classesType1 = {
			...
			if (userdata.inv[i] != undefined) {
				...
				if (data != false) {
					...
					iteminner.addEventListener('click', function() {
						...
						$('#inspect_price').innerHTML = (data.price * stattrak * wtp[userdata.inv[i].t]).toFixed(2) + 'â‚¬';
					...
					sellbtn.innerHTML = 'Sell ' + price.toFixed(2) + 'â‚¬';
...
function rendCaseShop() {
	...
	for (var i = 0; i < items.length; i++) {
		...
		if (data != false && data.type == 'case') {
			...
			buybtn.innerHTML = 'Buy for ' + data.price.toFixed(2) + 'â‚¬';
...
function checkRank() {
	...
	$('#rankTextRight').innerHTML = '<span>Earn</span> ' + (ranks[rank] - invv).toFixed(0) + 'â‚¬ <span>More</span>';
	...
	$('#rankText').innerHTML = 'Value: ' + (invv + dinvv).toFixed(2) + 'â‚¬';
...
function update() {
	if (canUpdate) {
		$('#cash').innerHTML = userdata.money.toFixed(2) + 'â‚¬';
...
function rendMoveInv(TradeFunction, jj) {
	...
	$('#tradeValue').innerHTML = price.toFixed(2) + 'â‚¬';
...
function JPchances() {
	...
	for (var i = 0; i < jpBets.length; i++) {
		...
		joined.innerHTML = '<th><img src="https://mtsl.dk/csgo/images/' + q + '"></th><th>' + jp_chances[i].name + '</th><td>' + jp_chances[i].chance.toFixed(2) + '%</td><td>' + jpBets[i].inv.toFixed(2) + 'â‚¬</td>';
...
if (((new Date().getTime() - JSON.parse(localStorage['lastOnline'])) / 1000 / 60) >= 1 && lte > 0.00) {
	showPopup('offline');
	$('#msg_wb_e').innerHTML = lte.toFixed(2) + 'â‚¬'
